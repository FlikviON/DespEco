...
class MultiplayerMenu:
    ...
    def _initialize_ui(self) -> None:
        ...
        self.title = ui_elements.Fonts.title_font.render("Multiplayer", True, ui_elements.Colors.dark_golden)
    ...
    def open_multiplayer_menu(self, screen: pygame.Surface) -> bool:
